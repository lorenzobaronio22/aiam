...
- WebSocket endpoints and bidirectional realtime channels
...
7. Treat WebSockets as bidirectional realtime channels: validate connection inputs with dependencies, reject unauthorized sessions with `WebSocketException`, handle disconnects explicitly, and test with `TestClient.websocket_connect()`.
